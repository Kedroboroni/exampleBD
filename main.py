...
import pandas as pd
import numpy as np
from engine import fill_general_tabel_from_numpy, query_to_numpy, count_repeat_all, count_repeat
...
with Session(engine) as db:
        #filled_records, skipped_rows = fill_general_tabel_from_numpy(db, dateArr)
    ...
    arr = find_objects_by_name_in_filtered_results(db, "city", "Россия", "-"), columns = ["nameObject", "city", "region"]
